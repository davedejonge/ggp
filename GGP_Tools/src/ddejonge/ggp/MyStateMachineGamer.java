...
/**
 * Adapted version of StateMachineGamer from the GGP Base.
 * Dave de Jonge
 * 
 ...
 * @author Sam
 */
public abstract class MyStateMachineGamer extends Gamer
{
	...
	// in BasicPlayer.
	// We call getInitialStateMachine();  and stateMachine.initialize(getMatch().getGame().getRules());
	// from the BasicPlayer.metaGame(), and then from there newMetaGame() is called to do the rest of the stuff
	// which cannot be done inside BasicPlayer, because it involves private fields.
	public void newMetaGame(long timeout) throws MetaGamingException{
...
*/
	...
	public final GdlTerm selectMove(long timeout) throws MoveSelectionException
	{
		...
		{
			System.out.println("MyStateMachineGamer.selectMove() ERROR!");
		    GamerLogger.logStackTrace("GamePlayer", e);
